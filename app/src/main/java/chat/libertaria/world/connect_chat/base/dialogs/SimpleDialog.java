package chat.libertaria.world.connect_chat.base.dialogs;
...
public class SimpleDialog extends Dialog {
    ...
    private SimpleTextDialog.Align alignBody;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root = findViewById(R.id.dialog_container);
    ...
    public SimpleDialog setOkBtnClickListener(View.OnClickListener okBtnClickListener) {
        this.okBtnClickListener = okBtnClickListener;
        return this;
    }

    public SimpleDialog setRootBackgroundRes(int rootBackgroundRes) {
        this.rootBackgroundRes = rootBackgroundRes;
        return this;
    }

    public void setAlignBody(SimpleTextDialog.Align alignBody) {
